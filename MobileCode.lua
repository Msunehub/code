...
local Decompile do
  local Success, Decompile_Source = pcall(function()
    return game:HttpGet("https://raw.githubusercontent.com/Msunehub/code/refs/heads/main/Opencode.lua", true)
  end)
...
Main = (function()
  ...
  Main.FetchRMD = function()
    ...
    if Main.Elevated then
      ...
      rawXML = rawXML or game:HttpGet("https://raw.githubusercontent.com/Msunehub/code/refs/heads/main/redCodex.xml")
    else
